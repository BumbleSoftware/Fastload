 ...
 * Examples of how to register events are found in {@link com.abdelaziz.fastload.client.FLClientHandler
...
public class EventFactory<T extends Record> {
     ...
     *                       for examples.
     */
    protected record EventHolder<T extends Record>(HashMap<Long, ArrayList<EventArgs<T>>> argsHolder,
